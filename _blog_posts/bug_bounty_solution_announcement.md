...
- Setting the initial scope of the assessment. That is, what **digital assets** (such as 3&ndash;5 public-facing websites, all web services under a particular domain, or a highly-sensitive system in pre-production) and **bug types** (for example, XSS or SQL injection) you want &mdash; and don't want &mdash; researchers to focus on.
