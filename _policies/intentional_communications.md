...
Skylight team members have created a list of words and phrases that replicate historic patterns of exclusion and marginalization. The list, which is always growing, is available [here](/assets/intentional-communications-resources.csv).
