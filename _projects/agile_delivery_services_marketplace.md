...
{% capture results %}
- **More than 700 participants** attracted to industry outreach events and more than 200 prototype-based submissions received via public GitHub repositories
- **All submissions evaluated within weeks** using a three-person team and contracts awarded to 17 vendors
- **Eight formal protests successfully defended** through the evaluation approach
...
- **Multiple federal, state, and local agencies** influenced to adopt similar approaches
- **Nearly a dozen agencies** enabled to achieve improved software delivery outcomes through better vendor selection
{% endcapture %}
