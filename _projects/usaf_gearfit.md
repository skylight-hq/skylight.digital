...
{% capture solution %}
We partnered with AFLCMC's HSD to build GearFit as both a product and an operating model for equipment feedback — designed to work within the realities of military operations and to scale over time. In 2019, female aviators raised fitment concerns at an event hosted by AFWERX, the Air Force's innovation hub, and was initiated through the Small Business Innovation Research authority.
