...
permalink: /work/experience/usaf-wxpo-bifrost/
image: /img/projects/usaf_wxpo_bifrost/wxpo-bifrost.svg
image_description: Disjointed weather icons merging into a clean interface shown on two computer screens. One screen shows a map with a flight route (origin, route line, destination, and a plane icon). The other shows a briefing form next to a map with "threat" blobs.
feature_image:
feature_image_description:
feature_image_shadow:
order: 550
