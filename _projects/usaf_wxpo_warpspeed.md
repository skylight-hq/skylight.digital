...
**Coaching through real projects — not classroom training — built capability that stuck.** On multiple WARPspeed teams — including [BIFROST](/work/experience/usaf-wxpo-bifrost/) and Environmental Workflow Application — our designers and product managers worked shoulder-to-shoulder with government counterparts on live projects. Skills transferred through real work rather than theory alone.
...
**Fragmented tools were part of the problem, so modern, organization-wide tooling became part of the fix.** We recommended organization-level tooling standards, trained designers and developers on Figma, cleaned up Confluence spaces, and onboarded more staff to Jira. A common stack cut handoff friction and freed teams to focus on design quality rather than tool workarounds.

**Backlogs, ticketing, and integrated testing improved alongside the design work — because design alone couldn't fix delivery.** We strengthened backlog management, clarified roles and responsibilities, and recommended improvements for integrated software testing. These operational changes helped teams move faster without sacrificing quality or losing sight of user needs.

**Without leadership coordination across teams, design improvements wouldn't compound across the portfolio.** We ran workshops to map dependencies, recommended a new strategy and integration role at the WARPspeed level, and introduced product management activities. Leadership now had the visibility needed to coordinate across a complex, multi-team portfolio.
