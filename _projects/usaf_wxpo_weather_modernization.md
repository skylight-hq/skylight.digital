...
{% capture summary %}
We’re partnering with the U.S. Air Force (USAF) Weather Systems Program Office (WxPO) to modernize how the Department of Defense (DoD) delivers weather intelligence. The engagement is migrating more than 75 applications to the cloud while building the design and delivery capabilities to sustain the transformation. Our work spans [cloud migration](/work/experience/usaf-wxpo-cloud-migration/), [design capability building](/work/experience/usaf-wxpo-warpspeed/), [platform redesign](/work/experience/usaf-wxpo-bifrost/), and [data management](/work/experience/usaf-wxpo-data-catalog/).
{% endcapture %}
...
**We started with [service design to diagnose what was stalling the migration](/work/experience/usaf-wxpo-cloud-migration/).** Rather than jumping to technical solutions, we applied our [Service Design Accelerator](/work/experience/usaf-service-design-capacity-building/) to understand the organizational dynamics holding teams back. We identified eight priority areas and embedded alongside WxPO staff to tackle each one — building their capacity to sustain progress independently.

With the migration unblocked, we turned to **[building the design capability](/work/experience/usaf-wxpo-warpspeed/) WxPO needed to deliver modern user experiences.** Using a player-coach model within WARPspeed — WxPO’s software factory — we embedded designers and product managers on delivery teams. We also introduced modern tooling and a shared design system, and strengthened delivery operations across the organization.

A functioning design practice made it possible to **[consolidate legacy workflows into BIFROST](/work/experience/usaf-wxpo-bifrost/).** We redesigned critical weather tools for forecasters, pilots, and mission planners while embedding repeatable research practices. The work rebuilt trust with a user community skeptical of modernization promises.

In parallel, we addressed a data infrastructure gap by **building a [searchable data catalog](/work/experience/usaf-wxpo-data-catalog/).** The application replaced manual spreadsheets — giving teams a single place to discover data products, manage subscriptions, and diagnose delivery issues.
{% endcapture %}
